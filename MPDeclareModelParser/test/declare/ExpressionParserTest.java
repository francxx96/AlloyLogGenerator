...
public class ExpressionParserTest {
    ...
    public void testGeneral() throws DeclareParserException {
        DataExpression ex = DataExpressionParser.parse("different TransportType and (B.TransportType is not Car or A.Price<=2) and A.TransportType in (Car, Plane,Train)");
